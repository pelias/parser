const testcase = (test, common) => {
  ...
  assert('N FISKE AVE Portland', [
    { street: 'N FISKE AVE' },
    { locality: 'Portland' },
  ]);
  assert('N DWIGHT AVE Portland O', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
  ]);
  assert('N DWIGHT AVE Portland Or', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
    { region: 'Or' },
  ]);
  assert('N DWIGHT AVE Portland Ore', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
  ]);
  assert('N DWIGHT AVE Portland Oreg', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
  ]);
  assert('N DWIGHT AVE Portland Orego', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
  ]);
  assert('N DWIGHT AVE Portland Oregon', [
    { street: 'N DWIGHT AVE' },
    { locality: 'Portland' },
    { region: 'Oregon' },
  ]);
  ...
  assert(
    ...
    [{ housenumber: '1210a' }, { street: 'Highway 10 W' }, { region: 'IA' }],
    true,
  );
  assert(
    '1210a State Highway 10',
    [{ housenumber: '1210a' }, { street: 'State Highway 10' }],
    true,
  );
  assert(
    '1389a County Road 42 IA',
    [{ housenumber: '1389a' }, { street: 'County Road 42' }, { region: 'IA' }],
    true,
  );

  assert(
    '9600 S Interstate 35 TX',
    [{ housenumber: '9600' }, { street: 'S Interstate 35' }, { region: 'TX' }],
    true,
  );
  assert(
    '9600 Interstate 35 TX',
    [{ housenumber: '9600' }, { street: 'Interstate 35' }, { region: 'TX' }],
    true,
  );
  ...
  assert(
    '1210a IA 10 W IA',
    [{ housenumber: '1210a' }, { street: 'IA 10 W' }, { region: 'IA' }],
    true,
  );
  assert(
    '1210a California 10',
    [{ housenumber: '1210a' }, { street: 'California 10' }],
    true,
  );
  assert(
    '1389a IA 42 IA',
    [{ housenumber: '1389a' }, { street: 'IA 42' }, { region: 'IA' }],
    true,
  );

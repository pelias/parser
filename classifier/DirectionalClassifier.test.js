...
module.exports.tests.english = (test) => {
  ...
  let invalid = ['northsouth', 'ns', 'ns.', 'westeast', 'we', 'we.'];
...
module.exports.tests.spanish = (test) => {
  ...
  let invalid = ['norsur', 'ns', 'ns.', 'oesteeste', 'we', 'we.'];
...
module.exports.tests.german = (test) => {
  ...
  let invalid = ['nordsüd', 'ns', 'ns.', 'westost', 'wo', 'wo.'];
...
module.exports.tests.french = (test) => {
  ...
  let invalid = ['nordsud', 'ns', 'ns.', 'ouestest', 'oe', 'oe.'];

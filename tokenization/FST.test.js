...
module.exports.tests._meta = (test) => {
  test('_meta', (t) => {
    ...
    t.equals(
      fst._walk(fst.head, '>', fst._split('e')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('ex')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('exa')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('exam')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('examp')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('exampl')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('example')).findOne('_meta')[
        '>count'
      ],
      1,
    );
    ...
    t.equals(
      fst._walk(fst.head, '>', fst._split('exc')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('exce')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('exces')).findOne('_meta')['>count'],
      1,
    );
    t.equals(
      fst._walk(fst.head, '>', fst._split('excess')).findOne('_meta')['>count'],
      1,
    );
    ...
    t.equals(
      fst._walk(fst.head, '>', fst._split('examples')).findOne('_meta')[
        '>count'
      ],
      1,
    );
